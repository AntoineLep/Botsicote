        ...
        if isinstance(search_string, str):
            ...
            for param in param_array:
                ...
                if param in ret:
                    ...
                    raise BotsicoteException("Can't find param %s in config file" % performed_param_str)

            return ret

        else:
            raise BotsicoteException("Given parameter for search_string must be a string! %s given instead" %
